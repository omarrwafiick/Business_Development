...
app.use(process.env.BASE_URL, businessRoutes);
app.use(process.env.BASE_URL, locationRoutes);
app.use(process.env.BASE_URL, serviceRoutes);
app.use(process.env.BASE_URL, consultantRoutes);
