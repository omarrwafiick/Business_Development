...
app.use(`${process.env.BASE_URL}${process.env.SERVICE_URL}${process.env.ENTREPRENEUR_URL}`, entrepreneurServiceRoutes);
app.use(`${process.env.BASE_URL}${process.env.SERVICE_URL}${process.env.CONSULTANT_URL}`, consultantServiceRoutes);
